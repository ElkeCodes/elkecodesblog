...
```html
<p class="lots-of-styling initial-all-styling">
  Initial styling after setting a bunch of other styles
</p>

<p class="initial-all-styling">
  Initial styling without custom styles on this paragraph
</p>
```
